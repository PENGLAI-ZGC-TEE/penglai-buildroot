...
BUILDROOT_MAKE = $(MAKE) -j$(BUILDROOT_JOBS) -C $(BUILDROOT_HOME) BR2_EXTERNAL=$(BR2_EXTERNAL_ZGC_TEE_PATH) O=$(BUILDROOT_OUTPUT)
BUILDROOT_LOCAL_MAKE = $(MAKE) -j$(BUILDROOT_JOBS) -C $(BUILDROOT_HOME) BR2_EXTERNAL=$(BR2_EXTERNAL_ZGC_TEE_PATH) BR2_PACKAGE_OVERRIDE_FILE=$(BUILDROOT_OVERRIDE_FILE) O=$(BUILDROOT_OUTPUT)
